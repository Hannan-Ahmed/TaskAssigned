...
const Sidebar = ({
  productComponent: ViewProduct,
  tableComponent: Table,
  editComponent: EditForm,
  addComponent: AddForm,
  cartComponent: Wallet,
  purchasComponent: ConnectedProductsTable,
}) => {
    ...
    <>
      <Suspense fallback={<Loader />}>
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <Link
                  onClick={() =>
                    alert(
                      "Please edit a product from the table and then you will be redirected"
                    )
                  }
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
              ...
              <li>
                <Link
                  onClick={() =>
                    alert(
                      "Please view a product and the add to cart and then you will proceed to wallet."
                    )
                  }
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                >
        ...
        <div className="p-4 sm:ml-64 ">
          ...
          {AddForm && <AddForm />}
          {Wallet && <Wallet />}
          {ConnectedProductsTable && <ConnectedProductsTable />}
        </div>
      </Suspense>
    </>
  );
